  ...
  get formItems() {
    return [
      ...
      },
      {
        ...
        type: 'switch',
        tip: t(
          'When enabled, this cluster template is public and can be seen and used by all projects. When disabled, it is only available within the project that created it.'
        ),
      },
    ];
  }
