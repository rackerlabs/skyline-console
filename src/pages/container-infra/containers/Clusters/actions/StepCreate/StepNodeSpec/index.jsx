  ...
  get formItems() {
    ...
    return [
      ...
      },
      {
        ...
        required: true,
        tip: t(
          'A minimum of 2 worker nodes is required. During an upgrade a worker node is deleted along with its pods, so having at least 2 workers leaves room to migrate workloads.'
        ),
        onChange: (value) => {
          this.updateContext({
            node_count: value,
